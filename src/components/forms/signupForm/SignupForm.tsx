        ...
        <div className='z-10 flex'>
          <div className='w-full max-w-md rounded-l-lg bg-white p-8 shadow-md'>
            ...
            <p className='mb-6 text-sm text-gray-600'>
              Create your account with specific email/mobile number; we can
              easily contact with you
            </p>
            <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
              <div className='flex flex-col'>
                ...
                <div className='flex items-center rounded-lg border border-gray-300'>
                  <input
                    id='name'
                    type='text'
                    className={`px-4 py-2 focus:outline-none ${errors.name ? 'border-red-500' : 'border-blue-500'}`}
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  className='mt-2 block w-full rounded-md border border-blue-500 bg-white px-4 py-2 text-gray-700 focus:border-2 focus:outline-none focus:ring-0'
                />
                <button
                  type='button'
                  onClick={() => setShowPassword(!showPassword)}
